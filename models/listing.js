...
const listingSchema = new Schema({
  ...
  image: {
    ...
    set: (v) => {
      if (typeof v === 'object') {
        return v.url || "https://default-image-url.com"; // Change this to your default image URL
      } else if (v === "") {
...
//middleware for delete review if we delete any listing use post middleware
